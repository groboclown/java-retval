...
class RetValTest {
    ...
    @Test
    void test_forwardProblems_problems_traceEnabled() {
    ...
    @Test
    void test_forwardProblems_problems_traceDisabled() {
    ...
    @Test
    void test_forwardNullableProblems_ok() {
        final RetVal<String> res = RetVal.ok("a");
        try {
    ...
    @Test
    void test_forwardNullableProblems_problems_traceEnabled() {
    ...
    @Test
    void test_thenValidate_initialProblem() {
    ...
    @Test
    void test_thenValidate_ok_nullOk() {
        final String[] acceptedValue = {"not set"};
    ...
    @Test
    void test_thenValidate_ok_emptyOk() {
        final String[] acceptedValue = {"not set"};
        final int[] callCount = {0};
        final RetVal<String> res = RetVal.ok("value");
        final RetVal<String> val = res.thenValidate((v) -> {
    ...
    @Test
    void test_thenValidate_ok_problem() {
        final String[] acceptedValue = {"not set"};
        final int[] callCount = {0};
        final LocalizedProblem problem = LocalizedProblem.from("x");
        final RetVal<String> res = RetVal.ok("value");
    ...
    @Test
    void test_thenNullable_ok_okNull() {
        final int[] acceptedValue = {0};
        final int[] callCount = {0};
        final RetVal<Integer> res = RetVal.ok(3);
        final RetNullable<Integer> val = res.thenNullable((v) -> {
    ...
    @Test
    void test_thenNullable_ok_problem() {
        final int[] acceptedValue = {0};
        final int[] callCount = {0};
        final LocalizedProblem problem = LocalizedProblem.from("p");
        final RetVal<Integer> res = RetVal.ok(3);
    ...
    @Test
    void test_thenNullable_problem() {
        final LocalizedProblem problem = LocalizedProblem.from("p");
        final RetVal<Integer> res = RetVal.fromProblem(problem);
        final RetNullable<Integer> val = res.thenNullable((v) -> {
            throw new IllegalStateException("unreachable code");
